...
# 选择要跑的模型
save_model_path = "C:/Users/win/Downloads\\GTN-master\\gesture_990 batch=16.pkl"
...
# 加载模型
net = torch.load(save_model_path, map_location=DEVICE)  # map_location 设置使用的设备，可能是因为原来的pkl是在colab上用GPU跑的
# 加载测试集数据
